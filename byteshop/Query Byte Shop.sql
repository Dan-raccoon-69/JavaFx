...
select existencias from Productos where idProducto = 14;
use byteshop;
update Productos set existencias = 3 where idProducto = 11;
/* TABLA DIRECCIONES ********************************************************************************/
...
use byteshop;
SELECT c.nombreCliente, fp.nombreFormaDePago, c.idFormaDePago
FROM clientes c
JOIN formasDePago fp ON c.idFormaDePago = fp.idFormaDePago where c.idCliente = 1;
...
use byteshop;
select * from ventas;
INSERT INTO ventas (idCliente, fechaDeCompra, idFormaDePago) VALUES
(1, '2023-05-01', 1),
(2, '2023-05-02', 2),
(3, '2023-05-03', 1),
(4, '2023-05-04', 3),
